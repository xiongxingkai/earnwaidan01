...
export function autoExport(serviceName) {
  return requestHttps({
    url: '/api/salary/excel-export/' + serviceName,
    method: 'post',
...
// 下载模板
export function downloadTemplate(serviceName) {
  return requestHttps({
    url: '/api/salary/excel-download-template/' + serviceName,
    method: 'get',
    responseType: 'arraybuffer'
  })
}
...
export function taskSubmit(obj) {
  return request({
    url: '/api/salary/form/workflow/submit',
    method: 'post',
    data: obj
  })
}
...
export function taskApproval(obj) {
  return request({
    url: '/api/salary/form/workflow/approval',
    method: 'post',
    data: obj
  })
}
...
export function taskReject(obj) {
  return request({
    url: '/api/salary/form/workflow/reject',
    method: 'post',
    data: obj
  })
}
...
export function getLinkage(obj) {
  return request({
    url: '/api/salary/front/data/linkage',
    method: 'post',
    data: obj
  })
}
